...
<body>
	...
	<div id="ranking">
		...
		<c:forEach items="${ list }" var="dto">
			<div class="person">
				...
				<a href="info?name=${ dto.name }">
				<img src="/hello/resources/heros/${ dto.image_two }.jpg" width="120px"><br>
				<div class="name">${ dto.name }</div></a>
				<div class="school">${ dto.school }</div>
				<div class="point">득표수: ${ dto.popularity }</div>
	...
	<input type="button" id="popularity" class="bts" onclick="goPower()" value="파워랭킹 보기"> 
	</div>
</body>
</html>